...
export const Dubai = () => {
  ...
  const packageInfo = [
    ...
    },
    {
      ...
      location: "kerla",
      price: "INR 4999",
      desc: "Discover kerla, with world-class tourism and magnificent tailored destinations. Explore a wide range of choices and start planning your trip now!",
    },
    {
      img: DubaiImages.dp4,
      location: "pune",
      price: "INR 4999",
      desc: "Discover pune, with world-class tourism and magnificent tailored destinations. Explore a wide range of choices and start planning your trip now!",
    },
  ];
  return (
    <>
