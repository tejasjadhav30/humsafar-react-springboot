...
import FlightForm from "./components/Flights/Flights";
import BookingForm from "./components/Flights/BookingForm";
import HotelForm from "./components/Flights/HotelForm";
import Booking from "./components/Flights/Paymentflight";
import BookingBus from "./components/Flights/Paymentbus";
import Bookinghotel from "./components/Flights/Bookinghotel";
function App() {
  return (
    <div className="App">
      <Router>
        ...
        <Routes>
          ...
          <Route path="/bus" element={<BookingForm />} />
          <Route path="/hotels" element={<HotelForm />} />
          <Route path="/booking/flights/:id" element={<Booking />} />
          <Route path="/booking/busbookings/:id" element={<BookingBus />} />
          <Route path="/booking/hotels/:id" element={<Bookinghotel />} />
